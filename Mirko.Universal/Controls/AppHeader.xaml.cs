...
namespace Mirko.Controls
{
    public sealed partial class AppHeader : UserControl
    {
        ...
        {
            get { return (SolidColorBrush)GetValue(LogoFillProperty); }
            set { SetValue(LogoFillProperty, value); }
        }

        // Using a DependencyProperty as the backing store for LogoFill.  This enables animation, styling, binding, etc...
        public static readonly DependencyProperty LogoFillProperty =
            DependencyProperty.Register("LogoFill", typeof(SolidColorBrush), typeof(AppHeader), new PropertyMetadata(null));
        
        public SolidColorBrush AppHeaderSelectionBrush
        {
            get { return (SolidColorBrush)GetValue(AppHeaderSelectionBrushProperty); }
            set { SetValue(AppHeaderSelectionBrushProperty, value); }
        }

        // Using a DependencyProperty as the backing store for AppHeaderSelectionBrush.  This enables animation, styling, binding, etc...
        public static readonly DependencyProperty AppHeaderSelectionBrushProperty =
            DependencyProperty.Register("AppHeaderSelectionBrush", typeof(SolidColorBrush), typeof(AppHeader), new PropertyMetadata(null));        
        #endregion
        ...
        private void NavService_Navigating(object source, StringEventArgs newPage)
        {
            ...
            if (currentPage == "HashtagSelectionPage")
            {
                ...
                this.HashCounter.Foreground = AppHeaderSelectionBrush;
            }
            else if (currentPage == "AtNotificationsPage")
            {
                this.AtCounter.OverrideForeground = true;
                this.AtCounter.Foreground = AppHeaderSelectionBrush;
            }
            else if (currentPage == "ConversationsPage")
            {
                this.PMCounter.OverrideForeground = true;
                this.PMCounter.Foreground = AppHeaderSelectionBrush;
            }
        ...
        private void DrawRegularLogo()
        {
            ...
            var outlinePath = new Path() { Height = 40, Width = 46, Stretch = Stretch.Uniform, Fill = LogoFill };
            var insidePath = new Path() { Height = 28, Width = 32, Stretch = Stretch.Uniform, Fill = LogoFill };
        ...
        private void DrawOfflineLogo()
        {
            ...
            var insidePath = new Path() { Height = 13, Width = 23, Stretch = Stretch.Uniform, Fill = LogoFill, Margin = new Thickness(0, -8, 0, 0) };
            var insidePath2 = new Path() { Height = 6, Width = 6, Stretch = Stretch.Uniform, Fill = LogoFill, Margin = new Thickness(0, 14, 0, 0) };
            var insidePath3 = new Path() { Height = 9, Width = 7, Stretch = Stretch.Uniform, Fill = LogoFill, Margin = new Thickness(-17.5, -10, 0, 0) };
            var insidePath4 = new Path() { Height = 9, Width = 4.5, Stretch = Stretch.Uniform, Fill = LogoFill, Margin = new Thickness(-12, 4, 0, 0) };
            var insidePath5 = new Path() { Height = 9, Width = 7, Stretch = Stretch.Uniform, Fill = LogoFill, Margin = new Thickness(17.5, -10, 0, 0) };
            var insidePath6 = new Path() { Height = 9, Width = 4.5, Stretch = Stretch.Uniform, Fill = LogoFill, Margin = new Thickness(12, 4, 0, 0) };
            var outlinePath = new Path() { Height = 40, Width = 46, Stretch = Stretch.Uniform, Fill = LogoFill };
            var trianglePath = new Path() { Height = 15, Width = 17, Stretch = Stretch.Uniform, Fill = LogoFill, Margin = new Thickness(28.5, 25, 0, 0) };
        ...
        private void DrawDonutLogo()
        {
            ...
            var outlinePath = new Path() { Height = 40, Width = 46, Stretch = Stretch.Uniform, Fill = LogoFill };
            var insidePath = new Path() { Width = 25, Stretch = Stretch.Uniform, Fill = LogoFill, Margin = new Thickness(0, -4, 0, 0) };
            var insidePath2 = new Path() { Width = 25, Stretch = Stretch.Uniform, Fill = LogoFill, Margin = new Thickness(0, 13, 0, 0) };
        ...
        private void DrawValentinesLogo()
        {
            ...
            var outlinePath = new Path() { Height = 40, Width = 46, Stretch = Stretch.Uniform, Fill = LogoFill };
            var insidePath = new Path() { Width = 20, Stretch = Stretch.Uniform, Fill = LogoFill, Margin = new Thickness(0, -1, 0, 0) };
        ...
        {
            if (Timer.IsEnabled || !App.IsMobile) return;
        ...
        {
            if (NotificationsPanel.Opacity == 0 && App.ApiService.UserInfo != null && App.IsMobile)
            {
        ...
        {
            StreamsPanel.IsHitTestVisible = false;
        }
        ...
        {
            NotificationsPanel.IsHitTestVisible = true;
        }
